        ...
        <div className={footerStyles.footer}>
            ...
            <div className={footerStyles.div}>
                <ul className={footerStyles.ul}>
                    ...
                    <li  className={footerStyles.li}>
                        <a href="https://github.com/orgs/Malagon-Hack-Club/dashboard" rel="noopener noreferrer" target="_blank">
                ...
                <li  className={footerStyles.li}>
                    <a  href="malagonhackclub@gmail.com" rel="noopener noreferrer" target="_blank">
